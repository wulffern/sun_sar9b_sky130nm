...
C {SUN_SAR9B_SKY130NM/SUNSAR_DFRNQNX1_CV.sym} 400 0 0 0 {name=XXB07}
...
N 360.0 40.0 380.0 40.0 {lab=ENABLE_B}
C {devices/lab_pin.sym} 360.0 40.0 0 0 {name=l2 sig_type=std_logic lab=ENABLE_B }
N 360.0 60.0 380.0 60.0 {lab=DO<7>}
C {devices/lab_pin.sym} 360.0 60.0 0 0 {name=l3 sig_type=std_logic lab=DO<7> }
N 360.0 80.0 380.0 80.0 {lab=DN7}
C {devices/lab_pin.sym} 360.0 80.0 0 0 {name=l4 sig_type=std_logic lab=DN7 }
